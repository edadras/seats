...
return [
    'kinds' => [
        ...
        'billing_invoiced' => [
            'title' => 'صورتحساب صادر شد',
            'body' => 'صورتحساب :number آماده است. سررسید آن :due است.',
        ],
        'billing_payment_failed' => [
            'title' => 'یک پرداخت انجام نشد',
            'body' => 'صورتحساب :number برداشت نشد: :reason. دوباره تلاش خواهد شد.',
        ],
        'billing_past_due' => [
            'title' => 'این حساب معوق است',
            'body' => 'صورتحساب :number پرداخت نشده و تلاش‌های مجدد تمام شده است: :reason. از صفحهٔ صورتحساب آن را تسویه کنید.',
        ],
    ],
];

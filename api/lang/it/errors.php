...
return [
    ...
    'period_runs_backwards' => 'Un periodo di pagamento deve finire il giorno in cui inizia o dopo.',
    'unknown_payout' => 'Questo pagamento non è stato trovato.',
    'period_already_invoiced' => 'Alcuni di quei giorni sono già su una fattura.',
    ...
    'demand_step_out_of_range' => 'Un gradino di domanda parte fra lo zero e il cento per cento venduto.',
    'demand_steps_collide' => 'Due gradini di domanda partono dalla stessa percentuale.',
    'rails_crossed' => 'Il prezzo più basso a cui vendete è sopra quello più alto.',
    ...
    'media_type_refused' => 'Questo tipo di file non si può usare qui. Immagini: JPEG, PNG, WebP o GIF; filmati: MP4, WebM o MOV.',
    'media_too_large' => 'Questo file supera :limit MB. Provane uno più piccolo.',
    'media_upload_failed' => 'Non è stato possibile leggere questo file. Forse il caricamento non è terminato.',
    ...
    'invitation_spent' => 'Questo invito è già stato usato.',
    'invitation_expired' => 'Questo invito è scaduto. Chiedine uno nuovo.',
    'invitation_account_closed' => 'L’organizzatore che ti ha invitato non accetta più accessi.',
    ...
    'agent_suspended' => 'Questo conto rivenditore è sospeso.',
    'agent_needs_email' => 'Un rivenditore ha bisogno di un indirizzo e-mail prima di poter avere un accesso.',
    'agent_event_not_allowed' => 'Questo evento non è stato affidato a questo rivenditore.',
    'agent_credit_exhausted' => 'Questa vendita supera quello che al rivenditore resta per vendere.',
    'agent_entry_kind' => 'Questo non è un tipo di movimento.',
    'agent_entry_needs_amount' => 'Indica l’importo.',
    ...
    'plan_already_agreed' => 'Questa prenotazione ha già un piano di pagamento. Modificalo invece di aggiungerne un secondo.',
    'unknown_order' => 'Prenotazione non trovata.',
    'instalment_already_paid' => 'Quel pagamento è stato incassato. Rimborsalo invece di riscriverlo.',
    'plan_needs_steps' => 'Un piano prevede da una a ventiquattro rate.',
    'plan_needs_amounts' => 'Ogni rata di un piano deve avere un importo.',
    'plan_does_not_add_up' => 'La somma delle rate deve corrispondere al prezzo della prenotazione.',
    ...
    'renewal_pass_elsewhere' => 'Quell’abbonamento appartiene a un’altra stagione.',
    'renewal_deadline_past' => 'Un rinnovo deve chiudersi nel futuro, altrimenti non è un’offerta.',
    'renewal_round_open' => 'Per questa stagione c’è già un rinnovo aperto. Chiudilo prima di aprirne un altro.',
    'renewal_round_closed' => 'Questo rinnovo è già chiuso.',
    'renewal_closed' => 'Questo rinnovo è terminato.',
    'renewal_answered' => 'A questo rinnovo è già stata data una risposta.',
    'renewal_no_nights' => 'Di questa stagione non è ancora in vendita nessuna serata.',
    ...
    'url_not_https' => 'L’indirizzo di un webhook deve iniziare con https://.',
    'url_not_a_name' => 'Indica un nome host anziché un indirizzo IP.',
    'url_unresolvable' => 'Quel nome host non risolve a nulla.',
    'url_private' => 'Quell’indirizzo è su una rete privata: questo server non lo aprirà.',

...
return [
    ...
    'kinds' => [
        ...
        'season_renewal' => [
            'name' => 'تجديد الاشتراك',
            'description' => 'يُرسل إلى مشتركي الموسم الماضي حين تُحجز مقاعدهم لهم. لا يمكن إيقافه — فقد يفقد أحدهم مقعداً جلس فيه سنين.',
        ],
        'membership_expiring' => [
            'name' => 'انتهاء العضوية',
            'description' => 'تُرسل قبل انتهاء العضوية بثلاثة أسابيع، لمن لم يجدّد بعد. مطفأة حتى تشغّلها.',
        ],
    ],
    'channels' => [
        'email' => 'البريد',
    ...
    'defaults' => [
        ...
        'season_renewal' => [
            'subject' => 'مقاعدك في {run}',
            'body' => "{buyer}، مقاعدك في {run} محجوزة لك: {seats}.\n\nهي لك حتى {deadline}، وبعدها تُطرح للبيع العام. للاحتفاظ بها، أو لإبلاغنا أنك لن تأتي هذا العام:\n{link}\n\n{site}",
        ],
        'membership_expiring' => [
            'subject' => 'تنتهي عضويتك في {scheme} يوم {ends}',
            'body' => "{buyer}، تنتهي عضويتك في {scheme} يوم {ends}.\n\nللاستمرار — ولتبقى تحجز قبل الجميع — جدّد من هنا:\n{link}\n\n{site}",
        ],
    ],
    'logKinds' => [
        'announcement' => 'إعلان',
    ...
    'sender' => [
        'title' => 'ممّن تأتي الرسالة',
        'description' => 'ما يراه المشتري في أعلى كل رسالة ترسلها إليه.',
        'ours' => 'عنواننا',
        'replies' => 'الردود تصلك',
        'fully' => 'عنوانك أنت',
        'preview' => 'يرى المشتري: :name <:address>',
        'replyTo' => 'يذهب الردّ إلى :address.',
        'name' => 'الاسم في خانة المرسِل',
        'email' => 'العنوان الذي ينبغي أن تصله الردود',
        'awaiting' => 'أرسلنا رمزاً من ستة أرقام إلى :address. اكتبه هنا لتأكيد أن العنوان لك.',
        'verify' => 'تأكيد',
        'again' => 'أرسله مجدداً',
        'domainHint' => 'يظهر اسمك فوراً. أما العنوان فيصبح عنوان الردّ بعد تأكيده — ويصبح عنوان المرسِل أيضاً إن كان مشغّل المنصّة قد هيّأ نطاقك للإرسال من هنا. فعل ذلك دون إعداد الـ DNS هو ما يجعل التأكيدات تنتهي في مجلد المزعجات.',
        'clear' => 'استخدم عنوان المنصّة',
        'saved' => 'حُفظ.',
        'codeSent' => 'الرمز في طريقه إلى ذلك العنوان.',
        'verified' => 'تم التأكيد. ستصلك الردود.',
        'cleared' => 'عُدنا إلى عنوان المنصّة.',
    ],
];

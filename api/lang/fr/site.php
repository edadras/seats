...
return [
    ...
    'inTowns' => 'dans une ville|dans :count villes',
    ...
    'chooseAWayToPay' => 'Choisissez un moyen de paiement.',
    ...
    'season' => [
        ...
        'savePercent' => 'Économisez :percent% sur toute la série',
        'saveAmount' => 'Économisez :amount sur toute la série',
        'chooseNights' => 'Choisissez au moins :count soirées',
        'everyNight' => 'Les :count soirées',
        'sameSeats' => 'Vous choisissez vos places une fois, le premier soir, et elles sont retenues pour chaque soirée que vous prenez.',
        'chooseSeats' => 'Choisir vos places',
        'pickAtLeast' => 'Choisissez au moins :count soirées.',
        'checkout' => 'Votre abonnement',
        'confirm' => 'Confirmer l’abonnement',
        'yourRun' => 'Vos soirées',
        'seatsPerNight' => ':count places chaque soir',
        'nightsCount' => ':count soirées',
        'saving' => 'Économie d’abonnement',
        'leave' => 'Acheter plutôt une seule soirée',
        'booked' => 'Vous avez votre abonnement',
        'orderLine' => ':pass · :nights soirées · réservation :reference',
        'yours' => 'Votre abonnement',
    ],
    'voucher' => [
        'label' => 'Bon cadeau',
        ...
        'line' => 'Payé par bon',
        'due' => 'Reste à payer',
        'settled' => 'Votre bon couvre cette réservation. Il ne reste rien à payer.',
        'settledWith' => ':amount de cette réservation ont été payés avec votre bon.',
        'credit' => 'Votre avoir',
        'remaining' => 'Il restera :amount',
        'refused' => [
            'unknown' => 'Nous ne connaissons pas ce bon.',
            'expired' => 'Ce bon est périmé.',
            'void' => 'Ce bon a été annulé.',
            'currency' => 'Ce bon est dans une autre devise.',
            'empty' => 'Il ne reste rien sur ce bon.',
        ],
    ],
    'discount' => [
    ...
    'addons' => [
        'bought' => 'Vous avez aussi acheté',
        'title' => 'Autre chose ?',
        'perTicket' => 'par billet',
        'left' => 'il n\'en reste que :count',
        'soldOut' => 'Épuisé',
    ],
    'donation' => [
        'title' => 'Souhaitez-vous donner quelque chose ?',

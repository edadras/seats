...
ALL=(
	...
	refund_smoke settlement_smoke wallet_smoke presale_smoke addons_smoke voucher_smoke season_smoke basket_smoke queue_smoke quota_smoke pace_smoke till_smoke limits_smoke messaging_smoke segments_smoke languages_smoke consent_smoke resale_smoke renewal_smoke import_smoke tiers_smoke promoters_smoke chargeback_smoke printing_smoke plans_smoke productions_smoke hall3d_smoke agents_smoke managers_smoke invite_smoke reports_smoke waitlist_smoke billing_smoke rehearsal_smoke leaving_smoke sso_smoke loyalty_smoke modules_smoke webhooks_smoke sender_smoke measurement_smoke memberships_smoke views_smoke webapp_smoke scanners_smoke bank_smoke firstrun_smoke ticket_design_smoke media_smoke calendar_smoke forms_smoke
